...
class _PinPageState extends State<PinPage> {
  ...
  addPin(String pin){
    if(pinController.text.length < 6){
      setState(() {
        pinController.text = pinController.text+pin;
      });
    }
      ...
      body: Center(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              //title
              Text('Sha PIN',style: whiteTextStyle.copyWith(fontSize: 20,fontWeight: semiBold),),
              ...
              SizedBox(
                ...
                child: TextFormField(
                  ...
                  style: whiteTextStyle.copyWith(fontSize: 26,fontWeight: medium,letterSpacing: 20),
              ...
              Wrap(
                ...
                children: [
                  ...
                  CustomInputButton(title: '0',onTap: (){addPin('0');},),
                  GestureDetector(
                    onTap: (){deletePin();},
                    child: Container(
                      width: 60,
